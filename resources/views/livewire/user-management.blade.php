            ...
            <x-filter-dropdown clear-action="resetFilters">
                <div class="flex flex-col gap-2 text-sm">
                    ...
                    <label class="inline-flex items-center gap-2">
                        <input type="checkbox" class="checkbox checkbox-xs" wire:model.live="filterUser" />
                        <span>User</span>
                    </label>
                    <label class="inline-flex items-center gap-2">
                        <input type="checkbox" class="checkbox checkbox-xs" wire:model.live="filterStatus" />
                        <span>Status</span>
                    </label>
                    <label class="inline-flex items-center gap-2">
                        <input type="checkbox" class="checkbox checkbox-xs" wire:model.live="filterSpecialization" />

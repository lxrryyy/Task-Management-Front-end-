<div>
    <div class="w-full">
        ...
        <div class="flex flex-col p-4 bg-white mt-4 rounded-lg">
            ...
            <dialog class="{{ $showPhotoConfirmModal ? 'modal modal-open' : 'modal' }}" wire:key="photo-confirm-modal" wire:ignore.self>
                <div class="modal-box max-w-md">
                    ...
                    <div class="modal-action">
                        ...
                        <button type="button" class="btn clr-bg-primary text-base-100" wire:click="confirmPhotoSelection">Confirm</button>
                    </div>
                </div>
            ...
            <div class="flex flex-row w-full gap-8 mt-4">
                <div class="flex flex-col flex-1">
                    ...
                    <input type="text" class="w-full rounded-lg border border-gray-300 px-3 py-2 mt-1" wire:model.defer="firstName">
                </div>
                <div class="flex flex-col flex-1">
                    <span>Last Name</span>
                    <input type="text" class="w-full rounded-lg border border-gray-300 px-3 py-2 mt-1" wire:model.defer="lastName">
                </div>
            </div>
            <div class="flex justify-between gap-8">
                <div class="flex flex-col gap-2 flex-1 mt-2">
                    <span>Bio/Specialization</span>
                    <input type="text" class="w-full rounded-lg border border-gray-300 px-3 py-2 mt-1" wire:model.defer="bio">
            ...
            <div class="flex justify-between gap-8">
                <div class="flex flex-col gap-2 flex-1 mt-2">
                    ...
                    <input type="password" class="w-full rounded-lg border border-gray-300 px-3 py-2 mt-1" wire:model.defer="currentPassword">
                </div>
            </div>
            <div class="flex justify-between gap-8">
                <div class="flex flex-col gap-2 flex-1 mt-2">
                    <span>New Password</span>
                    <input type="password" class="w-full rounded-lg border border-gray-300 px-3 py-2 mt-1" wire:model.defer="newPassword">
                </div>
            </div>
            <div class="flex justify-between gap-8">
                <div class="flex flex-col gap-2 flex-1 mt-2">
                    <span>Confirm Password</span>
                    <input type="password" class="w-full rounded-lg border border-gray-300 px-3 py-2 mt-1" wire:model.defer="confirmPassword">
                </div>
            </div>
            <div class="flex justify-end">
                <button
                    ...
                    class="btn w-48 text-base-100 mt-4 clr-bg-primary rounded-lg p-4"
                    @disabled($saving)
                >

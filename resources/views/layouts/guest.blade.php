...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        ...
        style="background-image: url('{{ asset('images/odecci-bg.png') }}');
            ...
            <div class="flex flex-col w-full justify-center items-center sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg h-[500px] sm:h-[600px]">
                <a href="/">

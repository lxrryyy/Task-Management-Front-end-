<x-guest-layout>
    ...
    <form class="flex flex-col gap-4 w-full" method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-6">
            <x-text-input id="email"
                ...
                type="text" value="{{ old('email') }}" name="email" placeholder="Enter your email" required
    ...
    "
                ...
                <svg id="eye-closed" style="display:none;" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
